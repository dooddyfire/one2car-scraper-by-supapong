...
#url = "https://www.one2car.com/รถมือสอง-สำหรับ-ขาย/toyota?page_size=12"
file_excel = input("ใส่ชื่อไฟล์ : ")
output_file_name = input("ใส่ชื่อไฟล์ output : ")
...
with open('{}.txt'.format(file_excel)) as f: 
    url_lis = f.readlines()
...
for url in url_lis: 
  ...
  for i in json_object[0]['itemListElement']:
...
df['มือ'] = car_hand_lis
df.to_excel("{}.xlsx".format(output_file_name))